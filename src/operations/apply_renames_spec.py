"""Tests for rename application logic."""
...
class DescribeApplyRenames:
    def should_rename_files_with_renamed_status(self, tmp_path):
    ...
    def should_rename_files_with_collision_status(self, tmp_path):
        img = tmp_path / "old.png"
        img.write_bytes(b"x")
        renamer = Mock(spec=FileRenamerPort)
    ...
    def should_skip_unchanged_results(self):
        renamer = Mock(spec=FileRenamerPort)
    ...
    def should_skip_error_results(self):
        renamer = Mock(spec=FileRenamerPort)
    ...
    def should_skip_results_without_path(self):
        renamer = Mock(spec=FileRenamerPort)
    ...
    def should_skip_when_final_equals_current_name(self, tmp_path):
    ...
    def should_return_total_renamed_count(self, tmp_path):
        img1 = tmp_path / "a.png"

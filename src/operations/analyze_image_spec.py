...
class DescribeAnalyzeImage:
    ...
    @pytest.fixture
    def mock_llm(self, mocker, fake_analysis):
        llm = mocker.MagicMock()
        llm.generate_object.return_value = fake_analysis
        return llm

    def should_call_llm_with_unified_prompt(self, tmp_image_path, mock_llm, mocker):
    ...
    def should_include_current_filename_in_prompt(self, tmp_image_path, mock_llm, mocker):
        mocker.patch("operations.analyze_image.MessageBuilder", _FakeMessage)
    ...
    def should_request_image_analysis_model(self, tmp_image_path, mock_llm, mocker):
        mocker.patch("operations.analyze_image.MessageBuilder", _FakeMessage)
    ...
    def should_return_image_analysis_result(self, tmp_image_path, mock_llm, fake_analysis, mocker):
        mocker.patch("operations.analyze_image.MessageBuilder", _FakeMessage)
